# how to run
# python visual_clip.py --video_folder_id "1Z8ZyToYAb6xG7aRWSiNDkbxBX8HOdUgV" --output_folder_id "15eifVkFWOhUxgOlc4Uf_i-WorhlagTKF"
...
def main():
    parser = argparse.ArgumentParser(description="Extract CLIP embeddings from Google Drive.")
